...
3. **[soxoj /maigret](https://github.com/soxoj/maigret)** — 🕵️‍♂️ Collect a dossier on a person by username from 3000+ sites
4. **[Hmbown /DeepSeek-TUI](https://github.com/Hmbown/DeepSeek-TUI)** — Coding agent for DeepSeek models that runs in your terminal
5. **[AIDC-AI /Pixelle-Video](https://github.com/AIDC-AI/Pixelle-Video)** — 🚀 AI 全自动短视频引擎 | AI Fully Automated Short Video Engine
...
9. **[openwrt /openwrt](https://github.com/openwrt/openwrt)** — This repository is a mirror ofhttps://git.openwrt.org/openwrt/openwrt.gitIt is for reference only and is not active for check-ins. We will continue to accept Pull Requests here. They will be merged via staging trees then into openwrt.git.
<!-- TRENDING-END -->
